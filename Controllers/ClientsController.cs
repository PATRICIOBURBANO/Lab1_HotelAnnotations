...
namespace Lab1_HotelAnnotations.Controllers
{
    public class ClientsController : Controller
    {
        private readonly Lab1_HotelAnnotationsContext _context;

        public ClientsController(Lab1_HotelAnnotationsContext context)
        {
            _context = context;
        }
